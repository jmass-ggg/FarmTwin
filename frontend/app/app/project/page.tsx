    ...
    <div className="content-stack project-page">
      <header className="page-heading project-heading">
        <div>
          ...
          <p>
            Implementation status is evidence-based. A phase is Verified only when the build log
            contains gate evidence. A polished screen does not imply the underlying analytics are
            complete or agronomically validated.
          </p>
        </div>
        <button
          className="copy-plan-btn"
          onClick={handleCopy}
          aria-label="Copy project plan to clipboard"
          title="Copy project_build.md to clipboard"
        >
      ...
      >
        ...
        <p className="architecture-note">
          <Layers3 /> The language layer may explain verified results later; it never invents
          measurements or calculates core scores.
        </p>
      </section>
      ...
      <section aria-labelledby="roadmap-title">
        <div className="section-heading-row">
          ...
          <p>Verified means build-log gate evidence exists.</p>
        </div>
      ...
      <section aria-labelledby="tech-stack-title">
        <div className="section-heading-row">
          <div>
            ...
            <h2 id="tech-stack-title">Tools and their roles</h2>
          </div>
          <p>Each tool has a specific, bounded responsibility.</p>
        </div>
