...
def build_decision_support(
    *,
    ...
    return {
        ...
        "model_version": "farmtwin-demo-decision-v1",
        "disclaimer": "Illustrative planning indices from a coordinate-aware demonstration climate profile. They are not observed farm conditions, forecasts, probabilities, or agronomic validation.",
        "assumptions": [
            "Soil suitability uses a visible neutral score because modeled soil evidence is not connected.",
            "Current environmental condition uses a visible neutral score because a farm snapshot is not available.",
            "Temperature and rainfall are reproducible seasonal demonstration values based on farm latitude, not live measurements.",
        ],
        "scenario": {
